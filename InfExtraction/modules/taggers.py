        ...
        def additional_preprocess(cls, data, data_type, **kwargs):
            ...
            for sample in tqdm(new_data, desc="additional preprocessing"):
                ...
                for event in sample["event_list"]:
                    ...
                    event_element_list.append(event_nodes_edges)
                ...
                sample["event_element_list"] = event_element_list
        ...
        def get_tag_points(self, sample):
            ...
            if "event_element_list" in sample:
                for event_elements in sample["event_element_list"]:
                    event_elements["ent_points"] = self.get_ent_points(event_elements["entity_list"])
                    event_elements["rel_points"] = self.get_rel_points(event_elements["relation_list"])
