...
default_run_log_dir = "./default_log_dir/run-{}_{}-{}".format(date.today().strftime("%Y%m%d"),
                                                                    str(time.time())[:6],
                                                                    default_run_id)
default_dir_to_save_model = default_run_log_dir
default_log_path = os.path.join(default_run_log_dir, "default_log.txt")
