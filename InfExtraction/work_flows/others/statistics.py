...
data_name = "share_14_clinic"
train_path = "../../../data/normal_data/{}/train_data.json".format(data_name)
valid_path = "../../../data/normal_data/{}/valid_data.json".format(data_name)
test_path = "../../../data/normal_data/{}/test_data.json".format(data_name)
